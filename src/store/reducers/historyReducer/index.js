...
export const setHistoryData = (history) => ({type:SET_HISTORY_DATA, payload:history})
export const setIsFetchingHistory = (bool) => ({type:SET_IS_FETCHING_HISTORY, payload:bool})
export const setFetchErrorHistory = (bool) => ({type:SET_FETCH_ERROR_HISTORY, payload:bool})
