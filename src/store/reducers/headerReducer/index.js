...
export const setCryptosHeader = (cryptos) => ({type:SET_CRYPTOS_HEADER, payload:cryptos})
export const setIsFetchingHeader = (bool) => ({type:SET_IS_FETCHING_HEADER, payload:bool})
export const setFetchErrorHeader = (bool) => ({type:SET_FETCH_ERROR_HEADER, payload:bool})
